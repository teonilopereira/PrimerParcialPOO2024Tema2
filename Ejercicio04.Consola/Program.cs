namespace Ejercicio04.Consola
{
    internal class Program
    {
        ...
        {
            //RepositorioNumerosPerfectos repositorio = new RepositorioNumerosPerfectos();
            //bool salir = false;
            ...
            //            {
            //                NumeroPerfecto numero = new NumeroPerfecto(valorAgregar);
            ...
            //            {
            //                NumeroPerfecto numero = new NumeroPerfecto(valorQuitar);
            //                var resultado = repositorio.Quitar(numero);
            //                Console.WriteLine(resultado.Item2);
            //            }
            //            else
            //            {
            ...
            //            {
            //                NumeroPerfecto numero = new NumeroPerfecto(valorBuscar);
            //                var resultado = repositorio.Buscar(numero);
            //                if (resultado.Item1)
            //                {
